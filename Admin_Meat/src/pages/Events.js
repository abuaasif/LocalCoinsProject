...
export const EventsOne = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await fetch('http://localhost:3001/api/catemeat');
        if (!response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/createmeat', {
        method: 'POST',
    ...
    <>
      ...
      <form className="row g-3 events-details" onSubmit={handleSubmit}>
        ...
        <div className="col-md-6">
          ...
          <input type="file" className="form-control" id="image1" name="images" onChange={handleImageChange} />
          <input type="file" className="form-control" id="image2" name="images" onChange={handleImageChange} />
          <input type="file" className="form-control" id="image3" name="images" onChange={handleImageChange} />
          <input type="file" className="form-control" id="image4" name="images" onChange={handleImageChange} />
